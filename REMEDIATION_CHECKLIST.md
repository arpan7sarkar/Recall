...
| 13 | `recall-performance-fix` | `/tmp/recall-worktrees/performance-fix` | 2026-08-24 | 2026-08-24 | Focused dashboard performance tests 3/3; source web 35/35; integrated web 39/39; web `tsc --noEmit`; changed-file lint passed; integrated web build passed | Source commit `c592666`, integrated as `a28660d`; graph render policy, bounded processing polling, near-viewport Instagram loading, and deduplicated Twitter widget changes verified in code and tests | Five-minute browser/server profiling and performance budgets remain unchecked. |
