...
import { ArrowRight, Search, Sparkles as SparklesIcon, Network, X, Check, Cloud } from "lucide-react";
      ...
      <main className="relative z-10 w-full flex flex-col items-center">
            ...
            <div className="mx-auto max-w-4xl px-6 text-center relative z-10">
                ...
                <div className="relative h-[80px] w-full group">
                    ...
                    >
                        ...
                        {/* Arc */}
                        <div className="w-32 flex items-center justify-center text-white">
                          <svg viewBox="0 0 180 56" fill="currentColor" className="w-full h-10">
                    ...
                    <ProgressiveBlur
                        className="pointer-events-none absolute top-0 left-0 h-full w-[200px] z-20"
                        direction="left"
                        blurIntensity={2}
                    />
                    <ProgressiveBlur
                        className="pointer-events-none absolute top-0 right-0 h-full w-[200px] z-20"
                        direction="right"
                        blurIntensity={2}
                    />
                </div>
        ...
        <section id="features" className="w-full max-w-7xl px-6 pb-32">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 auto-rows-[340px] md:auto-rows-[380px]">
              ...
              <div className="col-span-1 md:col-span-2 relative rounded-3xl bg-[#0e0e0e] border border-white/4 overflow-hidden flex flex-col justify-end p-10 group hover:border-white/10 transition-colors duration-500 shadow-xl">
                 <div className="absolute inset-x-0 bottom-0 top-0 bg-linear-to-tl from-black/80 via-transparent to-transparent z-10 pointer-events-none" />
              ...
              <div className="col-span-1 border-white/4 border bg-[#0e0e0e] rounded-3xl overflow-hidden relative p-8 flex flex-col justify-end group hover:border-white/10 transition-colors duration-500 shadow-xl">
                 <div className="absolute inset-x-0 bottom-0 top-0 bg-linear-to-b from-indigo-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
              ...
              <div className="col-span-1 border-white/4 border bg-[#0e0e0e] rounded-3xl overflow-hidden relative p-8 flex flex-col group hover:border-white/10 transition-colors duration-500 shadow-xl">
                 ...
                 {/* Decorative mock UI */}
                 <div className="w-full h-40 rounded-2xl bg-linear-to-br from-[#121a22] to-[#15202b] border border-white/5 p-5 relative overflow-hidden group-hover:scale-[1.02] transition-transform duration-700 mt-auto mx-auto shadow-inner">
              ...
              <div className="col-span-1 md:col-span-2 relative rounded-3xl bg-[#0e0e0e] border border-white/4 overflow-hidden flex flex-col justify-end p-10 group hover:border-white/10 transition-colors duration-500 shadow-xl">
                 <div className="absolute inset-y-0 right-0 w-2/3 bg-[radial-gradient(ellipse_at_center_right,var(--tw-gradient-stops))] from-indigo-900/10 via-transparent to-transparent pointer-events-none" />
