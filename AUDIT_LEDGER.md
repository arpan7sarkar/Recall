...
| UI-006 | High | Fixed | Save, update, archive, tag, and collection mutations invalidate inconsistent query and server caches. | Shared invalidation keys and server graph invalidation cover graph-affecting mutations. | `recall-sync` | Synchronization tests pass |
